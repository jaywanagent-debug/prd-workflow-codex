...
This file is modified for the `prd-workflow-codex` bundle. Use the bundled `show-me-the-prd` when the feature is not specified enough to enumerate inputs, states, and limits.
...
- The feature is not specified enough to enumerate inputs, states, and limits -> use bundled `show-me-the-prd` first
