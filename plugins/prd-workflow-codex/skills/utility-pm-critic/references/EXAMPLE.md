...
```
codex> /utility-pm-critic PRD/01_PRD.md
```
...
4. **Reads standards docs.** Per the pm-critic system prompt's referential discipline, reads `skills/show-me-the-prd/SKILL.md` (PRD contract), `skills/deliver-edge-cases/SKILL.md` (edge case completeness), and `skills/define-hypothesis/SKILL.md` (hypothesis-PRD coherence).
...
**Artifact reviewed:** `PRD/01_PRD.md`
**Standards consulted:** `skills/show-me-the-prd/SKILL.md`, `skills/deliver-edge-cases/SKILL.md`, `skills/define-hypothesis/SKILL.md`
...
**Why it matters:** Per `skills/show-me-the-prd/SKILL.md` and the bundled acceptance-criteria standard, a PRD must lead to testable behavior for engineering. External references create drift risk and ambiguity.
