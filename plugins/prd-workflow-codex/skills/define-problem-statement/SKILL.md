...
This file is modified for the `prd-workflow-codex` bundle. When the problem is agreed and the user needs a PRD, use the bundled `show-me-the-prd`.
...
- The problem is already agreed and engineering needs the spec -> use bundled `show-me-the-prd`
