...
This file is modified for the `prd-workflow-codex` bundle. Use the bundled `show-me-the-prd` when there is no story or feature slice to bind the criteria to.
...
- There is no story or slice to bind criteria to yet -> use bundled `show-me-the-prd` first
